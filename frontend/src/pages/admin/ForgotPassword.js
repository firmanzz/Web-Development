...
const ForgotPassword = () => {
  ...
  const handleForgotPassword = async () => {
    try {
      const response = await fetch('https://master-movie-cms.vercel.app/api/forgot-password', {
        method: 'POST',
        headers: {
  ...
  const handleResetPassword = async () => {
    try {
      const response = await fetch('https://master-movie-cms.vercel.app/api/reset-password', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
