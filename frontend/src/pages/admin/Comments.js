    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div>
            <label htmlFor="filterStatus" className="block text-sm font-medium text-gray-700">Filtered by:</label>
            <select id="filterStatus" className="form-select block w-full mt-1">
              <option>None</option>
          ...
          <div>
            <label htmlFor="showCount" className="block text-sm font-medium text-gray-700">Shows</label>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-800 text-white">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Drama</th>
