...
const Awards = () => {
  ...
  useEffect(() => {
    const fetchAwards = async () => {
      try {
        ...
        const response = await fetch("https://master-movie-cms.vercel.app/api/awards", {
          headers: {
    ...
    try {
      ...
      if (selectedAward) {
        response = await fetch(
          `https://master-movie-cms.vercel.app/api/awards/${selectedAward.id}`,
          {
            method: "PUT",
            headers: {
        ...
        response = await fetch("https://master-movie-cms.vercel.app/api/addAward", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`, // Add token to Authorization header
  ...
  const handleDeleteAward = async (id) => {
    try {
      const token = Cookies.get("token"); // Get token from cookies
      const response = await fetch(`https://master-movie-cms.vercel.app/api/awards/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`, // Add token to Authorization header
        },
