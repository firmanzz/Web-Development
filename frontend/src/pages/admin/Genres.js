...
const Genres = () => {
  ...
  useEffect(() => {
    const fetchGenres = async () => {
      try {
        ...
        const response = await fetch("https://master-movie-cms.vercel.app/api/genres", {
          headers: {
  ...
  const handleSubmit = async () => {
    try {
      const token = Cookies.get("token"); // Ambil token dari cookies
      const response = await fetch("https://master-movie-cms.vercel.app/api/addGenres", {
        method: "POST",
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = Cookies.get("token"); // Ambil token dari cookies
      const response = await fetch(`https://master-movie-cms.vercel.app/api/genres/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`, // Tambahkan token ke header Authorization
      },
    ...
    try {
      ...
      `https://master-movie-cms.vercel.app/api/genres/${editingGenreId}`,
      {
        method: "PUT",
        headers: {
        "Content-Type": "application/json",
