...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://master-movie-cms.vercel.app/api/login', {
        method: 'POST',
        headers: {
    ...
    <div className="flex items-center justify-center min-h-screen px-4 bg-gray-800">
      <div className="w-full max-w-xs p-6 bg-white rounded shadow-md">
        ...
        <p className="mt-1 text-center text-sm text-gray-600">
          ...
          <a href="https://web-development-beta-opal.vercel.app/forgot-password" className="text-blue-500 hover:underline">
            Click here
          </a>
        </p>
        <p className="mt-1 text-center text-sm text-gray-600">
