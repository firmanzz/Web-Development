...
const User = sequelize.define('User', {
  ...
  password: { type: DataTypes.STRING(255), allowNull: true }, // Password bisa nullable jika login dengan Google
  googleId: { type: DataTypes.STRING, allowNull: true }, // Tambahkan field ini
