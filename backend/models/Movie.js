...
Movie.belongsToMany(User, { through: Comment, foreignKey: 'movieid', otherKey: 'userid' });
User.belongsToMany(Movie, { through: Comment, foreignKey: 'userid', otherKey: 'movieid' });
